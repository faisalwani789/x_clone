...
export const addUser = async (req, res) => {
    ...
    const { fullName, email, rawPassword, username,id,bio='' } = req.body
    ...
    try {
        ...
        await conn.execute('call add_User(?,?,?,?,?,?,?,?)', [email, username, password, profile.url, coverImage?.url || "", fullName,bio,id])
